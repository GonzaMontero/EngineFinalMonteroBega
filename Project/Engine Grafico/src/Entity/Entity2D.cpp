...
namespace Engine {
	...
	void Entity2D::SetCollisionManager(CollisionManager* newCollisionManager)
	{
	...
	void Entity2D::ApplyCollisionRestriction(CollisionDirection direction, float xOverlap, float yOverlap, bool halfOverlap)
	{
